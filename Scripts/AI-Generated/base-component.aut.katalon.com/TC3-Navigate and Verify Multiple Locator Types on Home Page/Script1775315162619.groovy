...
WebUI.enhancedClick(findTestObject('AI-Generated/base-component.aut.katalon.com/Page_home/link_xpathBreakingCharacters'))

"Step 3: Click on link unicodeComboBox -> Navigate to page '/unicode-combobox'"

WebUI.enhancedClick(findTestObject('AI-Generated/base-component.aut.katalon.com/Page_xpath_breaking/link_unicodeComboBox'))

"Step 4: Click on link dynamicIdlocator -> Navigate to page '/dynamic-id-locator'"

WebUI.enhancedClick(findTestObject('AI-Generated/base-component.aut.katalon.com/Page_unicode_combobox/link_dynamicIdlocator'))

"Step 5: Click on div dynamicIdlocatorIssue"

WebUI.enhancedClick(findTestObject('AI-Generated/base-component.aut.katalon.com/Page_dynamic_id_locator/div_dynamicIdlocatorIssue'))

"Step 6: Click on link nestedTextLocatorPoc -> Navigate to page '/nested-text-locator-poc'"

WebUI.enhancedClick(findTestObject('AI-Generated/base-component.aut.katalon.com/Page_dynamic_id_locator/link_nestedTextLocatorPoc'))

"Step 7: Click on div directTextOnParent"

WebUI.enhancedClick(findTestObject('AI-Generated/base-component.aut.katalon.com/Page_nested_text_locator_poc/div_directTextOnParent'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/base-component.aut.katalon.com/Page_nested_text_locator_poc/div_nestedTextOnly'))

"Step 10: Click on div selectNestedTextOption"

WebUI.enhancedClick(findTestObject('AI-Generated/base-component.aut.katalon.com/Page_nested_text_locator_poc/div_selectNestedTextOption_1'))

"Step 11: Click on item selectRelationshipManagement"

WebUI.enhancedClick(findTestObject('AI-Generated/base-component.aut.katalon.com/Page_nested_text_locator_poc/item_selectRelationshipManagement_1'))
