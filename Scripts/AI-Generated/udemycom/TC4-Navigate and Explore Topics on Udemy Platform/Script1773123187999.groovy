...
WebUI.enhancedClick(findTestObject('AI-Generated/udemycom/Page_home/div_fullViewport'))

"Step 3: Click on div lohpBody"

WebUI.doubleClick(findTestObject('AI-Generated/udemycom/Page_home/div_lohpBody'))

"Step 4: Click on div fullViewport"

WebUI.doubleClick(findTestObject('AI-Generated/udemycom/Page_home/div_fullViewport'))

"Step 5: Click on link timHieuThem -> Navigate to page '/personal-plan'"

WebUI.doubleClick(findTestObject('AI-Generated/udemycom/Page_home/link_timHieuThem'))

"Step 6: Click on link udemyLogo -> Navigate to page '/'"

WebUI.enhancedClick(findTestObject('AI-Generated/udemycom/Page_personal_plan/link_udemyLogo'))

"Step 7: Click on link hocAi -> Navigate to page '/topic/artificial-intelligence'"

WebUI.doubleClick(findTestObject('AI-Generated/udemycom/Page_home/link_hocAi'))

"Step 8: Click on link udemyLogo -> Navigate to page '/'"

WebUI.enhancedClick(findTestObject('AI-Generated/udemycom/Page_topic_artificial_intelligence/link_udemyLogo'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/udemycom/Page_home/button_tiepTheo'))
...
WebUI.doubleClick(findTestObject('AI-Generated/udemycom/Page_home/button_truoc'))
...
WebUI.doubleClick(findTestObject('AI-Generated/udemycom/Page_home/div_icon'))

"Step 16: Click on link udemyLogo -> Navigate to page '/'"

WebUI.enhancedClick(findTestObject('AI-Generated/udemycom/Page_topic_generative_ai/link_udemyLogo'))

"Step 17: Click on button tiepTheo2"

WebUI.enhancedClick(findTestObject('AI-Generated/udemycom/Page_home/button_tiepTheo2'))
...
WebUI.doubleClick(findTestObject('AI-Generated/udemycom/Page_home/button_truoc2'))
...
WebUI.doubleClick(findTestObject('AI-Generated/udemycom/Page_home/button_tiepTheo2'))
...
WebUI.doubleClick(findTestObject('AI-Generated/udemycom/Page_home/link_udemyLogo'))
