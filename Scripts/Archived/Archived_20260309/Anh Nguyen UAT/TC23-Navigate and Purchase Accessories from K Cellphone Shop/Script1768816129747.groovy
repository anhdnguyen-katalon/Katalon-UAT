...
WebUI.enhancedClick(findTestObject('Archived/Archived_20260309/Anh Nguyen UAT/Page_product/main_product'))
...
WebUI.enhancedClick(findTestObject('Archived/Archived_20260309/Anh Nguyen UAT/Page_product/link_kCellphoneShop'))
...
WebUI.enhancedClick(findTestObject('Archived/Archived_20260309/Anh Nguyen UAT/Page_home/div_kCellphoneShop'))
...
WebUI.enhancedClick(findTestObject('Archived/Archived_20260309/Anh Nguyen UAT/Page_home/link_kCellphoneShopLogo'))

// WebUI.takeScreenshot(reportLocation + '/TC23/Step 6-Click on link kCellphoneShopLogo.png')

"Step 7: Click on button hamburgerMenu"

WebUI.enhancedClick(findTestObject('Archived/Archived_20260309/Anh Nguyen UAT/Page_home/button_hamburgerMenu'))

// WebUI.takeScreenshot(reportLocation + '/TC23/Step 7-Click on button hamburgerMenu.png')

"Step 8: Click on link accessories"

WebUI.enhancedClick(findTestObject('Archived/Archived_20260309/Anh Nguyen UAT/Page_home/link_accessories'))
...
WebUI.enhancedClick(findTestObject('Archived/Archived_20260309/Anh Nguyen UAT/Page_home/link_apple'))
...
WebUI.enhancedClick(findTestObject('Archived/Archived_20260309/Anh Nguyen UAT/Page_category_accessories_apple/button_addToCart'))
...
WebUI.enhancedClick(findTestObject('Archived/Archived_20260309/Anh Nguyen UAT/Page_category_accessories_apple/link_placeOrder'))
...
WebUI.enhancedClick(findTestObject('Archived/Archived_20260309/Anh Nguyen UAT/Page_cart/div_quantity'))

// WebUI.takeScreenshot(reportLocation + '/TC23/Step 12-Click on div quantity.png')

"Step 13: Click on button increaseQuantity"

WebUI.enhancedClick(findTestObject('Archived/Archived_20260309/Anh Nguyen UAT/Page_cart/button_increaseQuantity'))
...
WebUI.enhancedClick(findTestObject('Archived/Archived_20260309/Anh Nguyen UAT/Page_cart/button_proceedToCheckout'))
...
WebUI.enhancedClick(findTestObject('Archived/Archived_20260309/Anh Nguyen UAT/Page_checkout_info/div_logoWrapper'))
...
WebUI.enhancedClick(findTestObject('Archived/Archived_20260309/Anh Nguyen UAT/Page_checkout_info/link_backToCart'))
...
WebUI.enhancedClick(findTestObject('Archived/Archived_20260309/Anh Nguyen UAT/Page_cart/link_accessoriesFooter'))
